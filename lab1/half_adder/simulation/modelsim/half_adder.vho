...
-- output_vector[1]	=>  Location: PIN_C5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_E8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_C4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|g1|Y~combout\ : std_logic;
...
-- Equation(s):
-- \add_instance|g2|Y~0_combout\ = (\input_vector[1]~input_o\ & \input_vector[0]~input_o\)
...
\add_instance|g1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|g1|Y~combout\ = \input_vector[1]~input_o\ $ (\input_vector[0]~input_o\)
...
PORT MAP (
	dataa => \input_vector[1]~input_o\,
	datad => \input_vector[0]~input_o\,
	combout => \add_instance|g1|Y~combout\);
