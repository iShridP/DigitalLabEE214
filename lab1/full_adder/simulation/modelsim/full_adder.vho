...
-- output_vector[1]	=>  Location: PIN_P3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_N1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_P1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_N9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|g5|Y~0_combout\ : std_logic;
SIGNAL \add_instance|g2|Y~0_combout\ : std_logic;
...
\add_instance|g5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|g5|Y~0_combout\ = (\input_vector[1]~input_o\ & ((\input_vector[2]~input_o\) # (\input_vector[0]~input_o\))) # (!\input_vector[1]~input_o\ & (\input_vector[2]~input_o\ & \input_vector[0]~input_o\))
...
PORT MAP (
	...
	combout => \add_instance|g5|Y~0_combout\);

-- Location: LCCOMB_X4_Y3_N18
\add_instance|g2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|g2|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[2]~input_o\ $ (\input_vector[0]~input_o\))
...
PORT MAP (
	...
	datac => \input_vector[2]~input_o\,
	datad => \input_vector[0]~input_o\,
	combout => \add_instance|g2|Y~0_combout\);
